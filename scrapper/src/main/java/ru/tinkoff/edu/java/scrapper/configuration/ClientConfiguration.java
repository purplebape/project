...
import ru.tinkoff.edu.java.scrapper.clients.stackoverflowClient.StackOverflowClient;
import ru.tinkoff.edu.java.scrapper.clients.githubClient.GitHubClient;
...
public class ClientConfiguration {
    ...
    @Bean
    public GitHubClient gitHubWebClient(ApplicationConfig config) {
    ...
    @Bean
    public StackOverflowClient stackOverflowWebClient(ApplicationConfig config) {
